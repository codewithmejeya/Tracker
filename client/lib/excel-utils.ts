...
export function exportBranchesToExcel(
  branches: Branch[],
  filename: string = "branches.xlsx",
) {
...
export function importBranchesFromExcel(
  file: File,
    ...
    reader.onload = (e) => {
      try {
        ...
        jsonData.forEach((row: any, index: number) => {
          ...
          const location =
            row["Location"] || row["location"] || row["branch_location"];
